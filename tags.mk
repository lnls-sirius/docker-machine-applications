...
DEPLOY_TAG ?= 2021-11-26_test

# image tags used for starting docker services
IMG_IOCS_LI_PS_TAG ?= 2021-11-26_test
IMG_PYTHON_TAG ?= 2021-11-26_test # also used as base image for fac-epics
IMG_EPICS_TAG ?= 2021-11-26_test
IMG_DEPS_TAG ?= 2021-11-26_test
