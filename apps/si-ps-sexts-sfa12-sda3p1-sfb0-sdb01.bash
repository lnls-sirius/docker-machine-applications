...
# SI-Fam:PS-SDP1
# SI-Fam:PS-SFA2
/usr/local/bin/sirius-ioc-as-ps.py PA-RaPSB06:CO-PSCtrl-SI2 &> /ioc-logs/sirius-ioc-si-ps-sfa12-sda3p1.log & # 14.4%

# sirius-ioc-si-ps-sexts-sfb0-sdb01.service
# SI-Fam:PS-SDB1
# SI-Fam:PS-SFB0
# SI-Fam:PS-SDB0
/usr/local/bin/sirius-ioc-as-ps.py PA-RaPSB02:CO-PSCtrl-SI1 &> /ioc-logs/sirius-ioc-si-ps-sfb0-sdb01.log & # 11.6%
