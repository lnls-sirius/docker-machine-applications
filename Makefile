...
service-facs-as-ps-dclinks-tbts-bodip-start:
	cd services; docker stack deploy -c docker-stack-facs-as-ps-dclinks-tbts-bodip.yml facs-as-ps-dclinks-tbts-bodip
...
service-facs-as-ps-dclinks-ia01t10-start:
	cd services; docker stack deploy -c docker-stack-facs-as-ps-dclinks-ia01t10.yml facs-as-ps-dclinks-ia01t10
...
service-facs-as-ps-dclinks-ia11t20-start:
	cd services; docker stack deploy -c docker-stack-facs-as-ps-dclinks-ia11t20.yml facs-as-ps-dclinks-ia11t20
...
service-facs-bo-ps-corrs-ia01t10-start:
	cd services; docker stack deploy -c docker-stack-facs-bo-ps-corrs-ia01t10.yml facs-bo-ps-corrs-ia01t10
...
service-facs-bo-ps-corrs-ia11t20-start:
	cd services; docker stack deploy -c docker-stack-facs-bo-ps-corrs-ia11t20.yml facs-bo-ps-corrs-ia11t20

service-facs-ts-ps-stop:
	cd services; docker stack rm fac-facs-ts-ps

service-facs-ts-ps-start:
	cd services; docker stack deploy -c docker-stack-facs-ts-ps.yml facs-ts-ps

service-facs-si-ps-dips-stop:
	cd services; docker stack rm fac-facs-si-ps-dips

service-facs-si-ps-dips-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-dips.yml facs-si-ps-dips

service-facs-si-ps-quads-stop:
	cd services; docker stack rm fac-facs-si-ps-quads

service-facs-si-ps-quads-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-quads.yml facs-si-ps-quads

service-facs-si-ps-sexts-stop:
	cd services; docker stack rm fac-facs-si-ps-sexts

service-facs-si-ps-sexts-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-sexts.yml facs-si-ps-sexts
...
service-facs-si-ps-corrs-c2m12-ia01t10-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-corrs-c2m12-ia01t10.yml facs-si-ps-corrs-c2m12-ia01t10
...
service-facs-si-ps-corrs-c2m12-ia11t20-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-corrs-c2m12-ia11t20.yml facs-si-ps-corrs-c2m12-ia11t20
...
service-facs-si-ps-corrs-c134-ia01t10-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-corrs-c134-ia01t10.yml facs-si-ps-corrs-c134-ia01t10
...
service-facs-si-ps-corrs-c134-ia11t20-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-corrs-c134-ia11t20.yml facs-si-ps-corrs-c134-ia11t20
...
service-facs-si-ps-trims-m12-ia01t10-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-trims-m12-ia01t10.yml facs-si-ps-trims-m12-ia01t10
...
service-facs-si-ps-trims-m12-ia11t20-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-trims-m12-ia11t20.yml facs-si-ps-trims-m12-ia11t20
...
service-facs-si-ps-trims-c1234-ia01t10-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-trims-c1234-ia01t10.yml facs-si-ps-trims-c1234-ia01t10
...
service-facs-si-ps-trims-c1234-ia11t20-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ps-trims-c1234-ia11t20.yml facs-si-ps-trims-c1234-ia11t20

service-facs-as-pu-conv-stop:
	cd services; docker stack rm fac-facs-as-pu-conv

service-facs-as-pu-conv-start:
	cd services; docker stack deploy -c docker-stack-facs-as-pu-conv.yml facs-as-pu-conv

service-facs-as-ti-stop:
	cd services; docker stack rm fac-facs-as-ti

service-facs-as-ti-start:
	cd services; docker stack deploy -c docker-stack-facs-as-ti.yml facs-as-ti
...
service-facs-bo-ti-bpms-corrs-start:
	cd services; docker stack deploy -c docker-stack-facs-bo-ti-bpms-corrs.yml facs-bo-ti-bpms-corrs
...
service-facs-si-ti-bpms-corrs-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ti-bpms-corrs.yml facs-si-ti-bpms-corrs
...
service-facs-si-ti-trims-skews-start:
	cd services; docker stack deploy -c docker-stack-facs-si-ti-trims-skews.yml facs-si-ti-trims-skews

service-facs-as-ap-posang-stop:
	cd services; docker stack rm fac-facs-as-ap-posang

service-facs-as-ap-posang-start:
	cd services; docker stack deploy -c docker-stack-facs-as-ap-posang.yml facs-as-ap-posang
...
service-facs-all-start:
	cd services; \
	docker stack deploy -c docker-stack-facs-as-ps-dclinks-tbts-bodip.yml facs-as-ps-dclinks-tbts-bodip \
	docker stack deploy -c docker-stack-facs-as-ps-dclinks-ia01t10.yml facs-as-ps-dclinks-ia01t10 \
	docker stack deploy -c docker-stack-facs-as-ps-dclinks-ia11t20.yml facs-as-ps-dclinks-ia11t20 \
	docker stack deploy -c docker-stack-facs-li-ps-spect-quads-lens.yml facs-li-ps-spect-quads-lens \
	docker stack deploy -c docker-stack-facs-li-ps-corrs.yml facs-li-ps-corrs \
	docker stack deploy -c docker-stack-facs-li-ps-slnds.yml facs-li-ps-slnds \
	docker stack deploy -c docker-stack-facs-li-ps-conv.yml facs-li-ps-conv \
	docker stack deploy -c docker-stack-facs-li-ps-diag.yml facs-li-ps-diag \
	docker stack deploy -c docker-stack-facs-tb-ps.yml facs-tb-ps \
	docker stack deploy -c docker-stack-facs-bo-ps-dips.yml facs-bo-ps-dips \
	docker stack deploy -c docker-stack-facs-bo-ps-quads.yml facs-bo-ps-quads \
	docker stack deploy -c docker-stack-facs-bo-ps-sexts.yml facs-bo-ps-sexts \
	docker stack deploy -c docker-stack-facs-bo-ps-corrs-ia01t10.yml facs-bo-ps-corrs-ia01t10 \
	docker stack deploy -c docker-stack-facs-bo-ps-corrs-ia11t20.yml facs-bo-ps-corrs-ia11t20 \
	docker stack deploy -c docker-stack-facs-ts-ps.yml facs-ts-ps \
	docker stack deploy -c docker-stack-facs-si-ps-dips.yml facs-si-ps-dips \
	docker stack deploy -c docker-stack-facs-si-ps-quads.yml facs-si-ps-quads \
	docker stack deploy -c docker-stack-facs-si-ps-sexts.yml facs-si-ps-sexts \
	docker stack deploy -c docker-stack-facs-si-ps-corrs-c2m12-ia01t10.yml facs-si-ps-corrs-c2m12-ia01t10 \
	docker stack deploy -c docker-stack-facs-si-ps-corrs-c2m12-ia11t20.yml facs-si-ps-corrs-c2m12-ia11t20 \
	docker stack deploy -c docker-stack-facs-si-ps-corrs-c134-ia01t10.yml facs-si-ps-corrs-c134-ia01t10 \
	docker stack deploy -c docker-stack-facs-si-ps-corrs-c134-ia11t20.yml facs-si-ps-corrs-c134-ia11t20 \
	docker stack deploy -c docker-stack-facs-si-ps-trims-m12-ia01t10.yml facs-si-ps-trims-m12-ia01t10 \
	docker stack deploy -c docker-stack-facs-si-ps-trims-m12-ia11t20.yml facs-si-ps-trims-m12-ia11t20 \
	docker stack deploy -c docker-stack-facs-si-ps-trims-c1234-ia01t10.yml facs-si-ps-trims-c1234-ia01t10 \
	docker stack deploy -c docker-stack-facs-si-ps-trims-c1234-ia11t20.yml facs-si-ps-trims-c1234-ia11t20 \
	docker stack deploy -c docker-stack-facs-as-pu-conv.yml facs-as-pu-conv \
	docker stack deploy -c docker-stack-facs-as-ti.yml facs-as-ti \
	docker stack deploy -c docker-stack-facs-bo-ti-bpms-corrs.yml facs-bo-ti-bpms-corrs \
	docker stack deploy -c docker-stack-facs-si-ti-bpms-corrs.yml facs-si-ti-bpms-corrs \
	docker stack deploy -c docker-stack-facs-si-ti-trims-skews.yml facs-si-ti-trims-skews \
	docker stack deploy -c docker-stack-facs-as-ap-posang.yml facs-as-ap-posang \
	docker stack deploy -c docker-stack-facs-as-ap-opticscorr.yml facs-as-ap-opticscorr \
	docker stack deploy -c docker-stack-facs-as-ap-currinfo.yml facs-as-ap-currinfo \
	docker stack deploy -c docker-stack-facs-as-ap-sofb.yml facs-as-ap-sofb \
	docker stack deploy -c docker-stack-facs-si-ap-sofb.yml facs-si-ap-sofb \
	docker stack deploy -c docker-stack-facs-as-ap-diag.yml facs-as-ap-diag \
	docker stack deploy -c docker-stack-facs-li-ap-energy.yml facs-li-ap-energy \
	docker stack deploy -c docker-stack-facs-si-ap-bl.yml facs-si-ap-bl \
	docker stack deploy -c docker-stack-facs-si-id-conv.yml facs-si-id-conv \
	docker stack deploy -c docker-stack-facs-as-ap-machshift.yml facs-as-ap-machshift
